...
Analyze and optimize the following prompt for maximum cc4pm leverage.
...
3. **cc4pm Component Matching** — Map to specific skills, commands, agents, and model tier
...
- Present diagnosis, recommended cc4pm components, and an optimized prompt using the Output Format from the prompt-optimizer skill
