...
cc4pm 作为一个开源智能体性能测试系统，在 Claude Code、Cursor、OpenCode 和 Codex 应用程序/CLI 中得到维护。
...
| 成长合作伙伴 | $500/月 | 积极采用 cc4pm 的团队 | 试点权益 + 月度办公时间同步 + 工作流集成指导 |
