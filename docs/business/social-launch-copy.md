...
- npm installs (`cc4pm`, `ecc-agentshield`)
- GitHub App installs
...
In cc4pm we turned this into production checks via:
- /harness-audit
- /quality-gate
...
```text
We shipped cc4pm v1.8.0 with one objective: improve agent harness performance in production.
