...
description: "Save current session state to a dated file in the project's .Codex/sessions/ directory so work can be resumed in a future session with full context."
---
...
- Use the project-local session store: `<project-root>/.Codex/sessions/`
