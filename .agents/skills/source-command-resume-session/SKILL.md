...
description: "Load the most recent session file from the project's .Codex/sessions/ directory and resume work with full context from where the last session ended."
---
...
/resume-session ~/.Codex/sessions/2024-01-15-session.md           # loads a specific legacy-format file
/resume-session ~/.Codex/sessions/2024-01-15-abc123de-session.md  # loads a current short-id session file
```
...
2. Check `$PROJECT_ROOT/.Codex/sessions/`
...
- If it looks like a date (`YYYY-MM-DD`), search `$PROJECT_ROOT/.Codex/sessions/` for files matching
...
```
SESSION LOADED: /Users/you/.Codex/sessions/2024-01-15-abc123de-session.md
════════════════════════════════════════════════
