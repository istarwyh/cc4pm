...
- 完整学习：约 90-120 分钟（5 个阶段，26 节课 + 35 个补充课）
...
| 24.6 | cc-connect 实战：通过微信远程控制 Claude Code | cc-connect、ilink-protocol、wechat-bot-gateway、remote-claude-control、dir-command-admin、directory-switching |
