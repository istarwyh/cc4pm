...
- 完整学习：约 90-120 分钟（5 个阶段，26 节课 + 21 个补充课）
...
| 24.3 | graphify——用知识图谱秒懂任意知识库 | graphify-skill、knowledge-graph-from-codebase、god-nodes、token-efficiency-benchmark |
| 24.4 | cc-connect 实战：通过微信远程控制 Claude Code | cc-connect、ilink-protocol、wechat-bot-gateway、remote-claude-control |
