...
**Q: cc4pm 和 ECC (Everything Claude Code) 是什么关系？**

A: cc4pm 是基于 ECC 的深度定制版本。ECC 是 Anthropic 黑客马拉松获奖项目（GitHub 50K+ Stars），它奠定了代理、技能和自动化钩子的工程底座。cc4pm 在此基础上新增了 BMM（业务建模）、CIS（创意智能）、WDS（设计系统）三大方法论模块，使其从一个"开发者工具"进化为"面向产品主理人的完整 AI 协作平台"。

## 下一步

- [1] 进入补充课：Lesson 1.1 - Claude Code 工作原理——源码级深度解析
- [2] 跳过补充课，进入 Lesson 2 - 上下文窗口：你最重要的资源
- [3] 返回主菜单
- [4] 退出学习
