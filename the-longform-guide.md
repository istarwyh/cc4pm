# The Longform Guide to cc4pm

![Header: The Longform Guide to cc4pm](./assets/images/longform/01-header.png)

---

> **Prerequisite**: This guide builds on [The Shorthand Guide to cc4pm](./the-shortform-guide.md). Read that first if you haven't set up skills, hooks, subagents, MCPs, and plugins.
...
Everything covered in the shorthand and longform guides is available on GitHub: `github.com/istarwyh/cc4pm`
...
*Example of session storage -> <https://github.com/istarwyh/cc4pm/tree/main/examples/sessions>*
...
I've built these hooks and they're in the repo at `github.com/istarwyh/cc4pm/tree/main/hooks/memory-persistence`
...
I've built a continuous learning skill that does this: `github.com/istarwyh/cc4pm/tree/main/skills/continuous-learning`
...
*Everything covered in both guides is available on GitHub at [everything-claude-code](https://github.com/istarwyh/cc4pm)*
